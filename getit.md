...
## For Linux ![](http://cmollekopf.chickenkiller.com:8010/badges/nightlyflatpak.svg){: style="max-width: 120px; height: auto;"}
...
## For Mac OS ![](http://cmollekopf.chickenkiller.com:8010/badges/osxbuild.svg){: style="max-width: 120px; height: auto;"}
...
* Install the Kolab Now edition (Kolab Now exclusive) with the [Kolab Now flatpak](https://blogs.kolabnow.com/2017/09/27/kube-for-kolab-now): ![](http://cmollekopf.chickenkiller.com:8010/badges/kolabnowflatpak.svg){: style="max-width: 120px; height: auto;"}
```
...
```
* [Kolab Now Mac OS image](https://files.kube-project.com/kube-kolabnow.dmg) ![](http://cmollekopf.chickenkiller.com:8010/badges/kolabnowosxbuild.svg){: style="max-width: 120px; height: auto;"}
